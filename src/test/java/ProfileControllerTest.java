...
import com.login.ProfileController;
...
public class ProfileControllerTest {
    ...
    public void test_ModelAndView_WithSession() throws IOException, ServletException{
        ...
        expectedModelAndView.setViewName("welcome.jsp");
        assertEquals(expectedModelAndView.toString(),new ProfileController().profilePage(requestWithSession, response).toString());
    }
    ...
    public void test_ModelAndView_WithoutSession() throws IOException, ServletException{
        ModelAndView expectedModelAndView= new ModelAndView();
        expectedModelAndView.setViewName("welcome.jsp");
        assertEquals(expectedModelAndView.toString(),new ProfileController().profilePage(requestWithoutSession, response).toString());
    }
    ...
    public void test_Json_WithSession() throws IOException, ServletException{
        ...
        expectedJsonObject.put("message","Welcome");
        expectedJsonObject.put("name","UserName");
        new ProfileController().profilePage(requestWithSession, response);
        assertEquals(expectedJsonObject.toString(), ProfileController.jsonObject.toString());
    }
    ...
    public void test_Json_WithoutSession() throws IOException, ServletException{
        ...
        new ProfileController().profilePage(requestWithoutSession, response);
        assertEquals(expectedJsonObject.toString(), ProfileController.jsonObject.toString());
    }
